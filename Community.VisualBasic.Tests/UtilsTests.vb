...
Namespace Global.Community.VisualBasic.CompilerServices.Tests
  ...
  Public Class UtilsTests
    ...
    Public Sub CopyArray_NullSourceArray_ReturnsDestination()
      Dim destination As Array = Array.Empty(Of Object)()
    ...
    Public Sub CopyArray_EmptySourceArray_ReturnsDestination()
      Dim destination As Array = Array.Empty(Of Object)()
      Assert.Same(destination, Utils.CopyArray(Array.Empty(Of Integer)(), destination))
      Assert.Null(Utils.CopyArray(Array.Empty(Of Integer)(), Nothing))
    End Sub
    ...
    Public Sub GetResourceString()
      If System.Threading.Thread.CurrentThread.CurrentCulture.Name = "en-US" Then
        ...
        Assert.Equal("Argument '42' is not a valid value.", Utils.GetResourceString(ResourceKey:="Argument_InvalidValue1", {"42"}))
