...
'      Assert.Equal("3"c, Strings.Asc("3"c))
'    End Sub
...
'      Assert.Equal("3"c, Strings.AscW("3"c))
'    End Sub
...
'      AssertExtensions.Throws(Of ArgumentException)("String", Nothing, Function() Strings.AscW([String]))
'    End Sub
...
'      Assert.Equal(Convert.ToChar(charCode And &HFFFF), Strings.ChrW(charCode))
'    End Sub
...
'      AssertExtensions.Throws(Of ArgumentException)("CharCode", Nothing, Function() Strings.ChrW(charCode))
'    End Sub
...
'      Yield New Object() {New Object() {}, Nothing, Nothing}
'      Yield New Object() {New Object() {}, ",", Nothing}
...
'      Yield New Object() {New String() {}, ",", Nothing}
...
'    Public Sub StrConv(str As String, conversion As Microsoft.VisualBasic.VbStrConv, localeID As Integer, expected As String)
...
'      Yield New Object() {1, ChrW(AscW("A"c))}
