...
Imports Community.VisualBasic.CompilerServices.ConversionResolution.OperatorCaches
...
#End If
    ...
    Friend Shared Function ClassifyConversion(targetType As System.Type, sourceType As System.Type, ByRef operatorMethod As Method) As ConversionClass
    ...
    Friend Shared Function ClassifyPredefinedCLRConversion(targetType As System.Type, sourceType As System.Type) As ConversionClass
    ...
    Private Shared Function ClassifyCLRArrayToInterfaceConversion(targetInterface As System.Type, sourceArrayType As System.Type) As ConversionClass
    ...
    Private Shared Function ClassifyCLRConversionForArrayElementTypes(targetElementType As System.Type, sourceElementType As System.Type) As ConversionClass
    ...
    Friend Shared Function ClassifyPredefinedConversion(targetType As System.Type, sourceType As System.Type) As ConversionClass
...
sourceType As System.Type,
    ...
    Private Shared Function Encompasses(larger As System.Type, smaller As System.Type) As Boolean
    ...
    Private Shared Function NotEncompasses(larger As System.Type, smaller As System.Type) As Boolean
    ...
    Private Shared Function MostEncompassing(types As List(Of System.Type)) As System.Type
    ...
    Private Shared Function MostEncompassed(types As List(Of System.Type)) As System.Type
...
targetType As Type,
sourceType As Type,
searchList As List(Of Method),
resultList As List(Of Method),
...
operatorToInsert As Method,
operatorList As List(Of Method),
        ByRef genericMembersExistInList As Boolean)
...
targetType As System.Type,
sourceType As System.Type,
operatorSet As List(Of Method),
wideningOnly As Boolean,
...
targetType As Type,
sourceType As Type,
classification As ConversionClass,
operatorMethod As Method)
