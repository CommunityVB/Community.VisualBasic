...
Namespace Global.Community.VisualBasic.CompilerServices
  ...
  Public NotInheritable Class DateType
    ...
    Public Shared Function FromString(Value As String) As Date
      Return DateType.FromString(Value, GetCultureInfo())
    End Function

    Public Shared Function FromString(Value As String, culture As Globalization.CultureInfo) As Date
    ...
    Public Shared Function FromObject(Value As Object) As Date
    ...
    Friend Shared Function TryParse(Value As String, ByRef Result As System.DateTime) As Boolean
