...
Namespace Global.Community.VisualBasic.CompilerServices
  ...
  Class IOUtils
    ...
    Friend Shared Function FindFirstFile(assem As System.Reflection.Assembly, PathName As String, Attributes As IO.FileAttributes) As String
    ...
    Friend Shared Function FindNextFile(assem As System.Reflection.Assembly) As String
      Dim oAssemblyData As AssemblyData
