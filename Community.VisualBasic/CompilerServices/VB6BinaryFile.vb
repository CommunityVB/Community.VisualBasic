...
Namespace Global.Community.VisualBasic.CompilerServices
  ...
  Friend Class VB6BinaryFile
    ...
    Friend Overloads Overrides Sub Seek(BaseOnePosition As Long)
    ...
    Friend Overloads Overrides Sub [Get](ByRef Value As String, Optional RecordNumber As Long = 0, Optional StringIsFixedLength As Boolean = False)
      ValidateReadable()
