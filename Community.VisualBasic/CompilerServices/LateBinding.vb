...
Namespace Global.Community.VisualBasic.CompilerServices
  ...
  Public NotInheritable Class LateBinding
    ...
    <DebuggerHiddenAttribute(), DebuggerStepThroughAttribute()>
    Public Shared Sub LateSetComplex(o As Object,
                                     objType As Type,
                                     name As String,
                                     args() As Object,
                                     paramnames() As String,
    ...
    <DebuggerHiddenAttribute(), DebuggerStepThroughAttribute()>
    Public Shared Sub LateSet(o As Object,
                              objType As Type,
                              name As String,
                              args() As Object,
                              paramnames() As String)
    ...
    <DebuggerHiddenAttribute(), DebuggerStepThroughAttribute()>
    Public Shared Sub LateCall(o As Object,
                               objType As Type,
                               name As String,
                               args() As Object,
                               paramnames() As String,
    ...
    <DebuggerHiddenAttribute(), DebuggerStepThroughAttribute()>
    Friend Shared Function InternalLateCall(o As Object,
                                            objType As Type,
                                            name As String,
                                            args() As Object,
                                            paramnames() As String,
