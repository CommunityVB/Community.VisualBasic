...
Namespace Global.Community.VisualBasic.CompilerServices
  ...
  Partial Public NotInheritable Class Operators
    ...
    Friend Shared Function CollectOperators(op As UserDefinedOperator,
                                            type1 As System.Type,
                                            type2 As System.Type,
      ...
      If Not IsRootObjectType(type1) AndAlso IsClassOrValueType(type1) Then
        ...
        result = CollectOverloadCandidates(members,
                                           Nothing,
      ...
      If searchBothTypes AndAlso Not IsRootObjectType(type2) AndAlso IsClassOrValueType(type2) Then
        ...
        secondResult = CollectOverloadCandidates(members,
                                                 Nothing,
                                                 IIf(IsUnaryOperator(op), 1, 2),
                                                 Nothing,
                                                 Nothing,
    ...
    Friend Shared Function ResolveUserDefinedOperator(op As UserDefinedOperator,
                                                      arguments As Object(),
                                                      reportErrors As Boolean) As Method
      ...
      Dim candidates As List(Of Method) = CollectOperators(op,
                                                           leftType,
                                                           rightType,
                                                           foundLeftOperators,
                                                           foundRightOperators)
      ...
      If candidates.Count > 0 Then
        ...
        Return ResolveOverloadedCall(OperatorNames(op),
                                     candidates,
                                     arguments,
                                     NoArgumentNames,
                                     NoTypeArguments,
    ...
    Friend Shared Function InvokeUserDefinedOperator(operatorMethod As Method,
                                                     forceArgumentValidation As Boolean,
      ...
      If Not operatorMethod.ArgumentsValidated OrElse forceArgumentValidation Then
        ...
        If Not CanMatchArguments(operatorMethod, arguments, NoArgumentNames, NoTypeArguments, False, Nothing) Then
          ...
          If reportErrors Then
            ...
            Dim result As Boolean = CanMatchArguments(operatorMethod, arguments, NoArgumentNames, NoTypeArguments, False, errors)
      ...
      Return baseReference.InvokeMethod(operatorMethod,
                                        arguments,
                                        Nothing,
                                        BindingFlagsInvokeMethod)
    ...
    Public Shared Function FallbackInvokeUserDefinedOperator(vbOp As Object,
                                                             arguments As Object()) As Object
      Return InvokeObjectUserDefinedOperator(CType(vbOp, UserDefinedOperator), arguments)
    End Function

    Friend Shared Function InvokeObjectUserDefinedOperator(op As UserDefinedOperator,
                                                           arguments As Object()) As Object
    ...
    Friend Shared Function GetCallableUserDefinedOperator(op As UserDefinedOperator,
                                                          ParamArray arguments As Object()) As Method
