...
Namespace Global.Community.VisualBasic.CompilerServices
  ...
  Friend Class IDOBinder
    ...
    Private Structure SaveCopyBack
      ...
      Private ReadOnly _oldCopyBack As Boolean()
    ...
    Friend Shared Function IDOCall(instance As IDynamicMetaObjectProvider,
      ...
      Using s
        ...
        Try
          Return IDOUtils.CreateRefCallSiteAndInvoke(New VBCallBinder(memberName, callInfo, ignoreReturn), instance, packedArguments)
        Finally
  ...
  Friend Class VBCallBinder
    ...
    Public Overloads Overrides Function FallbackInvokeMember(target As DynamicMetaObject,
      ...
      IDOUtils.UnpackArguments(packedArgs, CallInfo, arguments, argNames, argValues)
  ...
  Friend Class VBConversionBinder
    ...
    Public Overrides Function FallbackConvert(target As DynamicMetaObject,
      ...
      If errorSuggestion IsNot Nothing AndAlso Not Conversions.CanUserDefinedConvert(target.Value, Type()) Then
      ...
      Dim fallback As Expression = Expression.Call(
          ...
          target.Expression(),
          Expression.Constant(Type(), GetType(System.Type))
      )
  ...
  Friend Class VBIndexSetBinder
    ...
    Public Overrides Function FallbackSetIndex(target As DynamicMetaObject,
      ...
      IDOUtils.UnpackArguments(packedIndexes, CallInfo, indexes, indexNames, indexValues)
  ...
  Friend Class IDOUtils
    ...
    Private Shared ReadOnly s_binderCache As New CacheSet(Of CallSiteBinder)(64)
