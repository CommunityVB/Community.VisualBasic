...
Imports Community.VisualBasic.CompilerServices.OverloadResolution
...
Namespace Global.Community.VisualBasic.CompilerServices
  ...
  Public NotInheritable Class NewLateBinding
    ...
    <System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)>
    <DebuggerHiddenAttribute()> <DebuggerStepThroughAttribute()>
    Public Shared Function LateCallInvokeDefault(Instance As Object,
                                                 Arguments As Object(),
                                                 ArgumentNames As String(),
                                                 ReportErrors As Boolean) As Object
    ...
    <System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)>
    <DebuggerHiddenAttribute()> <DebuggerStepThroughAttribute()>
    Public Shared Function LateGetInvokeDefault(Instance As Object,
                                                Arguments As Object(),
                                                ArgumentNames As String(),
                                                ReportErrors As Boolean) As Object
    ...
    Private Shared Function InternalLateInvokeDefault(instance As Object,
                                                      arguments As Object(),
                                                      argumentNames As String(),
    ...
    <System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)>
    <DebuggerHiddenAttribute()> <DebuggerStepThroughAttribute()>
    Public Shared Function FallbackInvokeDefault1(Instance As Object,
                                                  Arguments As Object(),
                                                  ArgumentNames As String(),
                                                  ReportErrors As Boolean) As Object
    ...
    <System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)>
    <DebuggerHiddenAttribute()> <DebuggerStepThroughAttribute()>
    Public Shared Function FallbackInvokeDefault2(Instance As Object,
                                                  Arguments As Object(),
                                                  ArgumentNames As String(),
                                                  ReportErrors As Boolean) As Object
    ...
    <DebuggerHiddenAttribute()> <DebuggerStepThroughAttribute()>
    Private Shared Function ObjectLateInvokeDefault(instance As Object,
                                                    arguments As Object(),
                                                    argumentNames As String(),
                                                    reportErrors As Boolean,
                                                    copyBack As Boolean()) As Object
    ...
    <DebuggerHiddenAttribute(), DebuggerStepThroughAttribute()>
    Public Shared Function LateIndexGet(Instance As Object,
                                        Arguments() As Object,
                                        ArgumentNames() As String) As Object
      Return InternalLateInvokeDefault(Instance, Arguments, ArgumentNames, True, Nothing)
    End Function

    Private Shared Function LateIndexGet(instance As Object,
                                         arguments() As Object,
                                         argumentNames() As String,
                                         copyBack As Boolean()) As Object
    ...
    Private Shared Function InternalLateIndexGet(instance As Object,
                                                 arguments() As Object,
                                                 argumentNames() As String,
                                                 reportErrors As Boolean,
    ...
    Friend Shared Function CanBindInvokeDefault(instance As Object,
                                                arguments As Object(),
                                                argumentNames As String(),
                                                reportErrors As Boolean) As Boolean
    ...
    <DebuggerHiddenAttribute(), DebuggerStepThroughAttribute()>
    Public Shared Function LateGet(Instance As Object,
                                   Type As System.Type,
                                   MemberName As String,
                                   Arguments As Object(),
                                   ArgumentNames As String(),
    ...
    <System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)>
    <DebuggerHiddenAttribute()> <DebuggerStepThroughAttribute()>
    Public Shared Function FallbackGet(Instance As Object,
                                       MemberName As String,
                                       Arguments As Object(),
                                       ArgumentNames As String()) As Object
    ...
    <DebuggerHiddenAttribute(), DebuggerStepThroughAttribute()>
    Private Shared Function ObjectLateGet(instance As Object,
                                          type As System.Type,
                                          memberName As String,
                                          arguments As Object(),
                                          argumentNames As String(),
      ...
      Dim targetProcedure As Method = ResolveCall(baseReference,
                                                  memberName,
                                                  members,
                                                  arguments,
                                                  argumentNames,
      ...
      ElseIf arguments.Length > 0 AndAlso members.Length = 1 AndAlso IsZeroArgumentCall(members(0)) Then
        ...
        targetProcedure = ResolveCall(baseReference,
                                      memberName,
                                      members,
                                      NoArguments,
                                      NoArgumentNames,
        ...
        If failure = OverloadResolution.ResolutionFailure.None Then
          ...
          If result Is Nothing Then
            Throw New MissingMemberException(SR.Format(SR.IntermediateLateBoundNothingResult1,
                                                       targetProcedure.ToString,
                                                       baseReference.VBFriendlyName))
          End If

          result = InternalLateIndexGet(result,
                                        arguments,
                                        argumentNames,
                                        False,
                                        failure,
    ...
    <DebuggerHiddenAttribute(), DebuggerStepThroughAttribute()>
    Public Shared Sub LateIndexSetComplex(Instance As Object,
                                          Arguments As Object(),
                                          ArgumentNames As String(),
    ...
    <System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)>
    <DebuggerHiddenAttribute(), DebuggerStepThroughAttribute()>
    Public Shared Sub FallbackIndexSetComplex(Instance As Object,
                                              Arguments As Object(),
                                              ArgumentNames As String(),
                                              OptimisticSet As Boolean,
                                              RValueBase As Boolean)
    ...
    <DebuggerHiddenAttribute(), DebuggerStepThroughAttribute()>
    Friend Shared Sub ObjectLateIndexSetComplex(instance As Object,
                                                arguments As Object(),
                                                argumentNames As String(),
                                                optimisticSet As Boolean,
                                                rValueBase As Boolean)
      ...
      If failure = OverloadResolution.ResolutionFailure.None Then
        ...
        If rValueBase AndAlso baseReference.IsValueType Then
          Throw New Exception(SR.Format(SR.RValueBaseForValueType,
                                        baseReference.VBFriendlyName,
                                        baseReference.VBFriendlyName))
        End If
    ...
    'Used by IDOBinder
    Friend Shared Function CanIndexSetComplex(instance As Object,
                                              arguments As Object(),
                                              argumentNames As String(),
                                              optimisticSet As Boolean,
                                              rValueBase As Boolean) As Boolean
    ...
    <DebuggerHiddenAttribute(), DebuggerStepThroughAttribute()>
    Public Shared Sub LateIndexSet(Instance As Object,
                                   Arguments() As Object,
                                   ArgumentNames() As String)
      Dim idmop As IDynamicMetaObjectProvider = IDOUtils.TryCastToIDMOP(Instance)
      If idmop IsNot Nothing Then
    ...
    <System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)>
    <DebuggerHiddenAttribute()> <DebuggerStepThroughAttribute()>
    Public Shared Sub FallbackIndexSet(Instance As Object,
                                       Arguments() As Object,
                                       ArgumentNames() As String)
      ObjectLateIndexSet(Instance, Arguments, ArgumentNames)
    End Sub
    ...
    <DebuggerHiddenAttribute(), DebuggerStepThroughAttribute()>
    Private Shared Sub ObjectLateIndexSet(Instance As Object,
                                          Arguments() As Object,
                                          ArgumentNames() As String)
    ...
    <DebuggerHiddenAttribute(), DebuggerStepThroughAttribute()>
    Public Shared Sub LateSetComplex(Instance As Object,
                                     Type As Type,
                                     MemberName As String,
                                     Arguments() As Object,
                                     ArgumentNames() As String,
    ...
    <DebuggerHiddenAttribute(), DebuggerStepThroughAttribute()>
    Friend Shared Sub ObjectLateSetComplex(instance As Object,
                                           type As Type,
                                           memberName As String,
                                           arguments() As Object,
                                           argumentNames() As String,
    ...
    <DebuggerHiddenAttribute(), DebuggerStepThroughAttribute()>
    Public Shared Sub LateSet(Instance As Object,
                              Type As Type,
                              MemberName As String,
                              Arguments() As Object,
                              ArgumentNames() As String,
    ...
    <System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)>
    <DebuggerHiddenAttribute(), DebuggerStepThroughAttribute()>
    Public Shared Sub FallbackSet(Instance As Object,
                                  MemberName As String,
                                  Arguments() As Object)
      ObjectLateSet(Instance, Nothing, MemberName, Arguments, NoArgumentNames, NoTypeArguments)
    End Sub

    Friend Shared Sub ObjectLateSet(instance As Object,
                                    type As Type,
                                    memberName As String,
                                    arguments() As Object,
                                    argumentNames() As String,
    ...
    Public Shared Sub LateSet(Instance As Object,
      ...
      If failure = OverloadResolution.ResolutionFailure.None OrElse failure = OverloadResolution.ResolutionFailure.MissingMember Then
        ...
        If failure = OverloadResolution.ResolutionFailure.None Then
          ...
          Dim result As Object = baseReference.InvokeMethod(targetProcedure, NoArguments, Nothing, secondaryInvocationFlags)
    ...
    Private Shared Function CallMethod(baseReference As Container,
                                       methodName As String,
                                       arguments As Object(),
                                       argumentNames As String(),
                                       typeArguments As System.Type(),
                                       copyBack As Boolean(),
                                       invocationFlags As BindingFlags,
                                       reportErrors As Boolean,
    ...
    Friend Shared Function ReportPropertyMismatch(targetProcedure As Method, flags As BindingFlags) As Exception
      ...
      If HasFlag(flags, BindingFlagsSetProperty) Then
        ...
        Return New MissingMemberException(SR.Format(SR.NoSetProperty1, targetProcedure.AsProperty.Name))
      Else
        Debug.Assert(targetProcedure.AsProperty.GetGetMethod Is Nothing, "expected error condition")
        Return New MissingMemberException(SR.Format(SR.NoGetProperty1, targetProcedure.AsProperty.Name))
      End If
    End Function

    Friend Shared Function ResolveCall(baseReference As Container,
                                       methodName As String,
                                       members As MemberInfo(),
                                       arguments As Object(),
                                       argumentNames As String(),
                                       typeArguments As Type(),
                                       lookupFlags As BindingFlags,
                                       reportErrors As Boolean,
      ...
      If members(0).MemberType <> MemberTypes.Method AndAlso
        ...
        If reportErrors Then
          ...
          Throw New ArgumentException(SR.Format(SR.ExpressionNotProcedure, methodName, baseReference.VBFriendlyName))
        End If
        Return Nothing
      ...
      Dim resolutionResult As Method = ResolveOverloadedCall(methodName,
                                                             members,
                                                             arguments,
                                                             argumentNames,
                                                             typeArguments,
...
#End If
      ...
      If Not resolutionResult.ArgumentsValidated Then
        ...
        If Not CanMatchArguments(resolutionResult, arguments, argumentNames, typeArguments, False, Nothing) Then
          ...
          If reportErrors Then
            ...
            Dim result As Boolean = CanMatchArguments(resolutionResult, arguments, argumentNames, typeArguments, False, errors)
      ...
      Else
        ...
        If HasFlag(lookupFlags, BindingFlagsSetProperty) Then
          ...
          If reportErrors Then
            ...
            Throw New MissingMemberException(SR.Format(SR.MethodAssignment1, resolutionResult.AsMethod.Name))
          End If
          Return Nothing
        End If
      End If
      ...
      If HasFlag(lookupFlags, BindingFlagsSetProperty) Then
        ...
        If Not CanPassToParameter(resolutionResult,
                                  lastArgument,
                                  lastParameter,
                                  False,
                                  False,
          ...
          If reportErrors Then
            ...
            Dim result As Boolean = CanPassToParameter(resolutionResult,
                                                       lastArgument,
                                                       lastParameter,
                                                       False,
                                                       False,
    ...
    Friend Shared Function ConstructCallArguments(targetProcedure As Method,
                                                  arguments As Object(),
                                                  lookupFlags As BindingFlags) As Object()
      ...
      If HasFlag(lookupFlags, BindingFlagsSetProperty) Then
        ...
        Dim lastParameter As ParameterInfo = parameters(parameters.Length - 1)
        callArguments(parameters.Length - 1) = PassToParameter(lastArgument, lastParameter, lastParameter.ParameterType)
