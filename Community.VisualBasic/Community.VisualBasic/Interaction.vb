...
Namespace Global.Community.VisualBasic
  ...
  Public Module Interaction
    ...
    Private ReadOnly m_EnvironSyncObject As New Object
...
#End If
    ...
    Friend Function IIf(Of T)(condition As Boolean, truePart As T, falsePart As T) As T
      If condition Then
        Return truePart
      End If
    ...
    Private Sub InsertSpaces(ByRef Buffer As String, Spaces As Long)
    ...
    Private Sub InsertNumber(ByRef Buffer As String, Num As Long, Spaces As Long)
...
#Disable Warning IDE0051 ' Remove unused private members
    ...
    Private Sub CheckPathComponent(s As String)
      If (s Is Nothing) OrElse (s.Length = 0) Then
...
#End If
    ...
    '============================================================================
    Public Function CallByName(ObjectRef As System.Object, ProcName As String, UseCallType As CallType, ParamArray Args() As Object) As Object
