...
Namespace Global.Community.VisualBasic.CompilerServices
  ...
  Public NotInheritable Class ProjectData
    ...
    Private ReadOnly m_CachedMSCoreLibAssembly As System.Reflection.Assembly = GetType(System.Int32).Assembly

    Friend Function GetAssemblyData(assem As System.Reflection.Assembly) As AssemblyData
    ...
    ''' <param name="hr"></param>
    ''' <returns></returns>
    Public Shared Function CreateProjectError(hr As Integer) As System.Exception
      '*************************
      '*** PERFORMANCE NOTE: ***
      '*************************
    ...
    ''' </summary>
    ''' <param name="ex"></param>
    Public Overloads Shared Sub SetProjectError(ex As Exception)
    ...
    Public Overloads Shared Sub SetProjectError(ex As Exception, lErl As Integer)
