...
Imports Community.VisualBasic.CompilerServices.StringType
...
Namespace Global.Community.VisualBasic.CompilerServices
  ...
  Public NotInheritable Class ObjectType
    ...
    Friend Shared Function IsWideningConversion(FromType As Type, ToType As Type) As Boolean
      ...
      Diagnostics.Debug.Assert(FromType IsNot ToType, "IsWideningConversion invalid for like types")
    ...
    Friend Overloads Shared Function GetWidestType(obj1 As Object, obj2 As Object, Optional IsAdd As Boolean = False) As TypeCode
    ...
    Friend Overloads Shared Function GetWidestType(obj1 As Object, type2 As TypeCode) As TypeCode
    ...
    Private Shared Function ObjTstInt16(d1 As Int16, d2 As Int16) As Integer
      If d1 < d2 Then
        Return -1
      ElseIf d1 > d2 Then
        Return 1
    ...
    Private Shared Function ObjTstInt32(d1 As Int32, d2 As Int32) As Integer
      If d1 < d2 Then
        Return -1
      ElseIf d1 > d2 Then
        Return 1
    ...
    Private Shared Function ObjTstInt64(d1 As Int64, d2 As Int64) As Integer
      If d1 < d2 Then
        Return -1
      ElseIf d1 > d2 Then
        Return 1
...
DecimalExit:
    ...
    Private Shared Function IDivideInt16(d1 As Int16, d2 As Int16) As Object
      Return d1 \ d2
    End Function

    Private Shared Function IDivideInt32(d1 As Int32, d2 As Int32) As Object
      Return d1 \ d2
    End Function

    Private Shared Function IDivideInt64(d1 As Int64, d2 As Int64) As Object
      Return d1 \ d2
    End Function

    Public Shared Function ShiftLeftObj(o1 As Object, amount As Int32) As Object
    ...
    Public Shared Function ShiftRightObj(o1 As Object, amount As Int32) As Object
    ...
    Friend Overloads Shared Function CTypeHelper(obj As Object, toType As TypeCode) As Object
    ...
    Friend Overloads Shared Function CTypeHelper(obj As Object, toType As Type) As Object
