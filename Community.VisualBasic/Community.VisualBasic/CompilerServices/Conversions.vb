...
ThrowInvalidCast:
    ...
    Private Shared Function GetNormalizedNumberFormat(InNumberFormat As NumberFormatInfo) As NumberFormatInfo
      ...
      With InNumberFormat
        If (.CurrencyDecimalSeparator IsNot Nothing) AndAlso
           (.NumberDecimalSeparator IsNot Nothing) AndAlso
           (.CurrencyGroupSeparator IsNot Nothing) AndAlso
           (.NumberGroupSeparator IsNot Nothing) AndAlso
...
MisMatch:
    ...
    Public Shared Shadows Function ToString(Value As Single, NumberFormat As NumberFormatInfo) As String
      Return Value.ToString(Nothing, NumberFormat)
    End Function

    Public Shared Shadows Function ToString(Value As Double, NumberFormat As NumberFormatInfo) As String
    ...
    Public Shared Shadows Function ToString(Value As Decimal, NumberFormat As NumberFormatInfo) As String
      Return Value.ToString("G", NumberFormat)
    End Function
    ...
    Private Shared Function CastInt16Enum(Expression As Int16, TargetType As Type) As Object
      If IsEnum(TargetType) Then Return [Enum].ToObject(TargetType, Expression)
      Return Expression
    End Function
    ...
    Private Shared Function CastInt32Enum(Expression As Int32, TargetType As Type) As Object
      If IsEnum(TargetType) Then Return [Enum].ToObject(TargetType, Expression)
      Return Expression
    End Function
    ...
    Private Shared Function CastInt64Enum(Expression As Int64, TargetType As Type) As Object
      If IsEnum(TargetType) Then Return [Enum].ToObject(TargetType, Expression)
      Return Expression
    End Function
...
Expression As Object, TargetType As Type) As Object
