...
Namespace Global.Community.VisualBasic.CompilerServices
  ...
  Friend Interface IRecordEnum
    Function Callback(FieldInfo As System.Reflection.FieldInfo, ByRef Value As Object) As Boolean
  End Interface
  ...
  Friend Class StructUtils
    ...
    Friend Shared Function EnumerateUDT(oStruct As ValueType, intfRecEnum As IRecordEnum, fGet As Boolean) As System.Object
    ...
    Private NotInheritable Class StructByteLengthHandler
      ...
      Private ReadOnly m_PackSize As Integer
      ...
      Friend Function Callback(field_info As Reflection.FieldInfo, ByRef vValue As Object) As Boolean Implements IRecordEnum.Callback
        Dim FieldType As System.Type
      ...
      Private Sub GetFieldSize(field_info As Reflection.FieldInfo, FieldType As System.Type, ByRef align As Integer, ByRef size As Integer)
