  ...
  Public NotInheritable Class LateBinding
    ...
    Public Shared Function LateGet(o As Object,
      ...
      Else
        ...
        If (mi IsNot Nothing) AndAlso (mi.MemberType = MemberTypes.Field) Then
          'SECURITY CHECK
      ...
      Catch ex As Exception When IsMissingMemberException(ex)
        ...
        If objType.IsCOMObject() OrElse ((args IsNot Nothing) AndAlso (args.Length > 0)) Then
          Dim oTmp As Object
    ...
    <DebuggerHiddenAttribute(), DebuggerStepThroughAttribute()>
    Public Shared Sub LateSetComplex(o As Object, objType As Type, name As String,
args() As Object, paramnames() As String,
OptimisticSet As Boolean, RValueBase As Boolean)
    ...
    <DebuggerHiddenAttribute(), DebuggerStepThroughAttribute()>
    Public Shared Sub LateSet(o As Object, objType As Type, name As String,
args() As Object, paramnames() As String)
    ...
    <DebuggerHiddenAttribute(), DebuggerStepThroughAttribute()>
    Friend Shared Sub InternalLateSet(o As Object,
        ...
        If Not objType.IsCOMObject() Then
          ...
          If members IsNot Nothing Then
            For i = 0 To members.GetUpperBound(0)
              ...
              If member IsNot Nothing AndAlso member.MemberType <> MemberTypes.Field Then
...
OptimisticSet As Boolean, RValueBase As Boolean)
    ...
    <DebuggerHiddenAttribute(), DebuggerStepThroughAttribute()>
    Public Shared Sub LateCall(o As Object, objType As Type, name As String,
args() As Object, paramnames() As String, CopyBack() As Boolean)

      InternalLateCall(o, objType, name, args, paramnames, CopyBack, True)
    End Sub

    <DebuggerHiddenAttribute(), DebuggerStepThroughAttribute()>
    Friend Shared Function InternalLateCall(o As Object, objType As Type, name As String,
args() As Object, paramnames() As String, CopyBack() As Boolean, IgnoreReturn As Boolean) As Object
      Dim flags As BindingFlags
    ...
    Private Shared Function GetMembersByName(objIReflect As IReflect, name As String, flags As BindingFlags) As MemberInfo()
      ...
      If (GetMembersByName IsNot Nothing) AndAlso (GetMembersByName.Length = 0) Then
        Return Nothing
      End If
    ...
    Private Shared Function MemberIsField(mi As MemberInfo()) As Boolean
      ...
      For Each ThisMember In mi
        If ThisMember IsNot Nothing Then
