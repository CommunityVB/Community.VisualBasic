...
Imports Community.VisualBasic.CompilerServices.Symbols
...
Namespace Global.Community.VisualBasic.CompilerServices
  ...
  Public NotInheritable Class Operators
    ...
    Private Shared Function ToVBBool(conv As Object) As SByte
      Return CSByte(Convert.ToBoolean(conv))
    End Function

    Private Shared Function GetTypeCode(o As Object) As TypeCode
...
#Region " Comparison Operators = <> < <= > >= "
    ...
    Private Shared Function CompareInt32(left As Int32, right As Int32) As CompareClass
      If left = right Then Return CompareClass.Equal
      If left > right Then Return CompareClass.Greater
      Return CompareClass.Less
    End Function
    ...
    Private Shared Function CompareInt64(left As Int64, right As Int64) As CompareClass
      If left = right Then Return CompareClass.Equal
      If left > right Then Return CompareClass.Greater
      Return CompareClass.Less
    End Function
    ...
    Private Shared Function CompareDecimal(left As Object, right As Object) As CompareClass
    ...
    Private Shared Function CompareDate(left As Date, right As Date) As CompareClass
...
#Region " Operator Negate - "
    ...
    Private Shared Function NegateInt16(operand As Int16) As Object
    ...
    Private Shared Function NegateInt32(operand As Int32) As Object
    ...
    Private Shared Function NegateInt64(operand As Int64) As Object
...
#Region " Operator Not "
    ...
    Private Shared Function NotInt16(operand As Int16, operandType As Type) As Object
    ...
    Private Shared Function NotInt32(operand As Int32, operandType As Type) As Object
    ...
    Private Shared Function NotInt64(operand As Int64) As Object
      Return Not operand
    End Function

    Private Shared Function NotInt64(operand As Int64, operandType As Type) As Object
...
#Region " Operator And "
    ...
    Private Shared Function AndInt16(left As Int16, right As Int16, Optional enumType As Type = Nothing) As Object
    ...
    Private Shared Function AndInt32(left As Int32, right As Int32, Optional enumType As Type = Nothing) As Object
    ...
    Private Shared Function AndInt64(left As Int64, right As Int64, Optional enumType As Type = Nothing) As Object
...
#Region " Operator Or "
    ...
    Private Shared Function OrInt16(left As Int16, right As Int16, Optional enumType As Type = Nothing) As Object
    ...
    Private Shared Function OrInt32(left As Int32, right As Int32, Optional enumType As Type = Nothing) As Object
    ...
    Private Shared Function OrInt64(left As Int64, right As Int64, Optional enumType As Type = Nothing) As Object
...
#Region " Operator Xor "
    ...
    Private Shared Function XorInt16(left As Int16, right As Int16, Optional enumType As Type = Nothing) As Object
    ...
    Private Shared Function XorInt32(left As Int32, right As Int32, Optional enumType As Type = Nothing) As Object
    ...
    Private Shared Function XorInt64(left As Int64, right As Int64, Optional enumType As Type = Nothing) As Object
...
#Region " Operator Plus + "
    ...
    Private Shared Function AddInt16(left As Int16, right As Int16) As Object
    ...
    Private Shared Function AddInt32(left As Int32, right As Int32) As Object
    ...
    Private Shared Function AddInt64(left As Int64, right As Int64) As Object
    ...
    Private Shared Function AddDecimal(left As Object, right As Object) As Object
...
#Region " Operator Minus - "
    ...
    Private Shared Function SubtractInt16(left As Int16, right As Int16) As Object
    ...
    Private Shared Function SubtractInt32(left As Int32, right As Int32) As Object
    ...
    Private Shared Function SubtractInt64(left As Int64, right As Int64) As Object
    ...
    Private Shared Function SubtractDecimal(left As Object, right As Object) As Object
      Dim leftValue As Decimal = Convert.ToDecimal(left)
      Dim rightValue As Decimal = Convert.ToDecimal(right)
...
#Region " Operator Multiply * "
    ...
    Private Shared Function MultiplyInt16(left As Int16, right As Int16) As Object
    ...
    Private Shared Function MultiplyInt32(left As Int32, right As Int32) As Object
    ...
    Private Shared Function MultiplyInt64(left As Int64, right As Int64) As Object
      Try
        Return left * right
      Catch ex As OverflowException
      End Try
    ...
    Private Shared Function MultiplyDecimal(left As Object, right As Object) As Object
      Dim leftValue As Decimal = Convert.ToDecimal(left)
      Dim rightValue As Decimal = Convert.ToDecimal(right)
...
#Region " Operator Divide / "
    ...
    Private Shared Function DivideDecimal(left As Object, right As Object) As Object
      Dim leftValue As Decimal = Convert.ToDecimal(left)
      Dim rightValue As Decimal = Convert.ToDecimal(right)
...
#Region " Operator Mod "
    ...
    Private Shared Function ModInt16(left As Int16, right As Int16) As Object
      Return left Mod right
    End Function
    ...
    Private Shared Function ModInt64(left As Int64, right As Int64) As Object
    ...
    Private Shared Function ModDecimal(left As Object, right As Object) As Object
      Dim leftValue As Decimal = Convert.ToDecimal(left)
      Dim rightValue As Decimal = Convert.ToDecimal(right)
...
#Region " Operator Integral Divide \ "
    ...
    Private Shared Function IntDivideInt16(left As Int16, right As Int16) As Object
    ...
    Private Shared Function IntDivideInt32(left As Int32, right As Int32) As Object
      If left = Integer.MinValue AndAlso right = -1 Then
    ...
    Private Shared Function IntDivideInt64(left As Int64, right As Int64) As Object
      Return left \ right
    End Function
