...
Imports Community.VisualBasic.CompilerServices.ConversionResolution
...
leftSignature As ParameterInfo(),
leftTypeParameterCount As Integer,
rightSignature As ParameterInfo(),
rightTypeParameterCount As Integer) As Boolean

      If leftTypeParameterCount <> 0 OrElse
         rightTypeParameterCount <> 0 Then
      End If
...
leftParameter As ParameterInfo,
leftProcedure As MethodBase,
expandLeftParamArray As Boolean,
rightParameter As ParameterInfo,
rightProcedure As MethodBase,
expandRightParamArray As Boolean,
        ByRef leftWins As Boolean,
        ByRef rightWins As Boolean,
...
leftParameter As ParameterInfo,
rawLeftParameter As ParameterInfo,
leftMember As Method,
expandLeftParamArray As Boolean,
rightParameter As ParameterInfo,
rawRightParameter As ParameterInfo,
rightMember As Method,
expandRightParamArray As Boolean,
...
left As Method,
right As Method,
compareGenericity As ComparisonType,
...
newCandidate As MemberInfo,
newCandidateSignature As ParameterInfo(),
newCandidateParamArrayIndex As Integer,
expandNewCandidateParamArray As Boolean,
arguments As Object(),
argumentCount As Integer,
argumentNames As String(),
typeArguments As Type(),
collectOnlyOperators As Boolean,
candidates As List(Of Method),
baseReference As Container)
...
targetType As Type,
sourceType As Type,
rejectNarrowingConversion As Boolean,
errors As List(Of String),
parameterName As String,
isByRefCopyBackContext As Boolean,
...
typeInferenceArguments As Type(),
targetProcedure As MethodBase,
digThroughToBasesAndImplements As Boolean) As Boolean
...
argument As Object,
parameter As ParameterInfo) As Boolean

      If targetProcedure IsNot Nothing Then
      End If
...
isExpandedParamArray As Boolean,
rejectNarrowingConversions As Boolean,
errors As List(Of String),
        ByRef requiresNarrowingConversion As Boolean,
        ByRef allNarrowingIsFromObject As Boolean) As Boolean
...
argument As Object,
parameter As ParameterInfo,
parameterType As Type) As Object
...
compareGenericity As ComparisonType,
        ...
        Optional continueWhenBothLose As Boolean = False) As Method
...
candidates As List(Of Method),
        ByRef candidateCount As Integer,
arguments As Object(),
argumentNames As String()) As Method
...
substitution1 As String,
substitution2 As Type,
substitution3 As Type)
...
overloadedProcedureName As String,
candidates As List(Of Method),
arguments As Object(),
argumentNames As String(),
typeArguments As Type(),
errorID As String,
failure As ResolutionFailure,
detector As ArgumentDetector,
candidateFilter As CandidateProperty) As Exception
...
argumentNames As String(),
typeArguments As Type(),
failure As ResolutionFailure) As Exception
...
reportErrors As Boolean,
      ...
      If lookupFlags <> BindingFlags.Default Then
      End If
...
baseReference As Container) As Method
