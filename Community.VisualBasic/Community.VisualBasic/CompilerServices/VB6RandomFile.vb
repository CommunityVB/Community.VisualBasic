  ...
  Friend Class VB6RandomFile
    ...
    Friend Overrides Sub OpenFile()
      ...
      If (m_access = OpenAccess.Write) OrElse (m_access = OpenAccess.ReadWrite) Then
        m_sw = New StreamWriter(stm, m_Encoding) With {
          .AutoFlush = True
        }
    ...
    Friend Overloads Overrides Sub Lock(lStart As Long, lEnd As Long)
      If lStart > lEnd Then
    ...
    Friend Overloads Overrides Sub Unlock(lStart As Long, lEnd As Long)
      If lStart > lEnd Then
        Throw New ArgumentException(SR.Format(SR.Argument_InvalidValue1, "Start"))
      End If
    ...
    Friend Overloads Overrides Sub Seek(Position As Long)
      SetRecord(Position)
    End Sub
    ...
    ' Get
    '======================================
    Friend Overrides Sub GetObject(ByRef Value As Object, Optional RecordNumber As Long = 0,
        Optional ContainedInVariant As Boolean = True)
    ...
    Friend Overloads Overrides Sub [Get](ByRef Value As ValueType, Optional RecordNumber As Long = 0)
      ValidateReadable()
      GetRecord(RecordNumber, Value, False)
    End Sub

    Friend Overloads Overrides Sub [Get](ByRef Value As System.Array, Optional RecordNumber As Long = 0,
    ...
    Friend Overloads Overrides Sub [Get](ByRef Value As Boolean, Optional RecordNumber As Long = 0)
      ValidateReadable()
      Value = GetBoolean(RecordNumber)
    End Sub

    Friend Overloads Overrides Sub [Get](ByRef Value As Byte, Optional RecordNumber As Long = 0)
      ValidateReadable()
      Value = GetByte(RecordNumber)
    End Sub

    Friend Overloads Overrides Sub [Get](ByRef Value As Short, Optional RecordNumber As Long = 0)
      ValidateReadable()
      Value = GetShort(RecordNumber)
    End Sub

    Friend Overloads Overrides Sub [Get](ByRef Value As Integer, Optional RecordNumber As Long = 0)
      ValidateReadable()
      Value = GetInteger(RecordNumber)
    End Sub

    Friend Overloads Overrides Sub [Get](ByRef Value As Long, Optional RecordNumber As Long = 0)
      ValidateReadable()
      Value = GetLong(RecordNumber)
    End Sub

    Friend Overloads Overrides Sub [Get](ByRef Value As Char, Optional RecordNumber As Long = 0)
      ValidateReadable()
      Value = GetChar(RecordNumber)
    End Sub

    Friend Overloads Overrides Sub [Get](ByRef Value As Single, Optional RecordNumber As Long = 0)
      ValidateReadable()
      Value = GetSingle(RecordNumber)
    End Sub

    Friend Overloads Overrides Sub [Get](ByRef Value As Double, Optional RecordNumber As Long = 0)
      ValidateReadable()
      Value = GetDouble(RecordNumber)
    End Sub

    Friend Overloads Overrides Sub [Get](ByRef Value As Decimal, Optional RecordNumber As Long = 0)
      ValidateReadable()
      Value = GetCurrency(RecordNumber)
    End Sub

    Friend Overloads Overrides Sub [Get](ByRef Value As String, Optional RecordNumber As Long = 0,
    ...
    Friend Overloads Overrides Sub [Get](ByRef Value As Date, Optional RecordNumber As Long = 0)
      ValidateReadable()
      Value = GetDate(RecordNumber)
    End Sub

    Friend Overrides Sub PutObject(Value As Object, Optional RecordNumber As Long = 0,
        Optional ContainedInVariant As Boolean = True)
    ...
    Friend Overloads Overrides Sub Put(Value As ValueType, Optional RecordNumber As Long = 0)
      ValidateWriteable()
      PutRecord(RecordNumber, Value)
    End Sub

    Friend Overloads Overrides Sub Put(Value As System.Array, Optional RecordNumber As Long = 0,
        Optional ArrayIsDynamic As Boolean = False, Optional StringIsFixedLength As Boolean = False)
    ...
    Friend Overloads Overrides Sub Put(Value As Boolean, Optional RecordNumber As Long = 0)
      ValidateWriteable()
      PutBoolean(RecordNumber, Value)
    End Sub

    Friend Overloads Overrides Sub Put(Value As Byte, Optional RecordNumber As Long = 0)
      ValidateWriteable()
      PutByte(RecordNumber, Value)
    End Sub

    Friend Overloads Overrides Sub Put(Value As Short, Optional RecordNumber As Long = 0)
      ValidateWriteable()
      PutShort(RecordNumber, Value)
    End Sub

    Friend Overloads Overrides Sub Put(Value As Integer, Optional RecordNumber As Long = 0)
      ValidateWriteable()
      PutInteger(RecordNumber, Value)
    End Sub

    Friend Overloads Overrides Sub Put(Value As Long, Optional RecordNumber As Long = 0)
      ValidateWriteable()
      PutLong(RecordNumber, Value)
    End Sub

    Friend Overloads Overrides Sub Put(Value As Char, Optional RecordNumber As Long = 0)
      ValidateWriteable()
      PutChar(RecordNumber, Value)
    End Sub

    Friend Overloads Overrides Sub Put(Value As Single, Optional RecordNumber As Long = 0)
      ValidateWriteable()
      PutSingle(RecordNumber, Value)
    End Sub

    Friend Overloads Overrides Sub Put(Value As Double, Optional RecordNumber As Long = 0)
      ValidateWriteable()
      PutDouble(RecordNumber, Value)
    End Sub

    Friend Overloads Overrides Sub Put(Value As Decimal, Optional RecordNumber As Long = 0)
      ValidateWriteable()
      PutCurrency(RecordNumber, Value)
    End Sub

    Friend Overloads Overrides Sub Put(Value As String, Optional RecordNumber As Long = 0, Optional StringIsFixedLength As Boolean = False)
      ValidateWriteable()
    ...
    Friend Overloads Overrides Sub Put(Value As Date, Optional RecordNumber As Long = 0)
      ValidateWriteable()
