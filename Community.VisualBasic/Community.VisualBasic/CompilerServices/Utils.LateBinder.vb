...
Namespace Global.Community.VisualBasic.CompilerServices
  ...
  Partial Public NotInheritable Class Utils
    ...
    Private Shared Function GetFallbackMessage(name As String, ParamArray args() As Object) As String
    ...
    Public Shared Function GetResourceString(ResourceKey As String, ParamArray Args() As String) As String
      ...
      System.Diagnostics.Debug.Assert(Args IsNot Nothing, "No Args")
    ...
    Friend Shared Function OctFromULong(Val As ULong) As String
      'System.Radix is being removed from the .NET platform, so compute this locally.
      Dim Buffer As String = ""
      Dim ModVal As Integer
      Dim CharZero As Integer = Convert.ToInt32(chZero)
    ...
    Friend Shared ReadOnly Property VBRuntimeAssembly() As System.Reflection.Assembly
      Get
        If s_VBRuntimeAssembly IsNot Nothing Then
    ...
    Friend Shared Function IsHexOrOctValue(value As String, ByRef i64Value As Int64) As Boolean
...
GetSpecialValue:
    ...
    Friend Shared Function VBFriendlyName(typ As System.Type) As String
...
#End If
    ...
    Private Shared Function GetGenericArgsSuffix(typ As Type) As String
      ...
      If typ.DeclaringType IsNot Nothing AndAlso typ.DeclaringType.IsGenericType Then
        typeArgsCount -= typ.DeclaringType.GetGenericArguments().Length
      End If
    ...
    Friend Shared Function MethodToString(method As Reflection.MethodBase) As String
    ...
    Friend Shared Function PropertyToString(prop As Reflection.PropertyInfo) As String
