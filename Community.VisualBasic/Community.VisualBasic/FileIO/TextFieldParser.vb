...
Namespace Global.Community.VisualBasic.FileIO
  ...
  Public Class TextFieldParser
    ...
    ''' <remarks></remarks>
    Public Sub New(path As String, defaultEncoding As System.Text.Encoding)
    ...
    ''' <remarks></remarks>
    Public Sub New(path As String, defaultEncoding As System.Text.Encoding, detectEncoding As Boolean)
    ...
    ''' <param name="defaultEncoding">The decoding to default to if encoding isn't determined from file</param>
    ''' <remarks></remarks>
    Public Sub New(stream As Stream, defaultEncoding As System.Text.Encoding)
    ...
    ''' <param name="detectEncoding">Indicates whether or not to try to detect the encoding from the BOM</param>
    ''' <remarks></remarks>
    Public Sub New(stream As Stream, defaultEncoding As System.Text.Encoding, detectEncoding As Boolean)
    ...
    ''' <remarks></remarks>
    Public Sub New(stream As Stream, defaultEncoding As System.Text.Encoding, detectEncoding As Boolean, leaveOpen As Boolean)
    ...
    Private Sub InitializeFromPath(path As String, defaultEncoding As System.Text.Encoding, detectEncoding As Boolean)
    ...
    Private Sub InitializeFromStream(stream As Stream, defaultEncoding As System.Text.Encoding, detectEncoding As Boolean)
    ...
    Private ReadOnly m_WhiteSpaceRegEx As Regex = New Regex("\s", REGEX_OPTIONS)
    ...
    Private ReadOnly m_LeaveOpen As Boolean
  End Class
  ...
  Friend Class QuoteDelimitedFieldBuilder
    ...
    Private ReadOnly m_Field As New StringBuilder
