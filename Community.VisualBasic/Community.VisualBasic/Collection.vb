...
Namespace Global.Community.VisualBasic
  ...
  Public NotInheritable Class Collection : Implements ICollection, IList
    ...
    Default Public Overloads ReadOnly Property Item(Index As Integer) As Object
    ...
    Default Public Overloads ReadOnly Property Item(Key As String) As Object
      Get
        If Key Is Nothing Then
    ...
    Default Public Overloads ReadOnly Property Item(Index As Object) As Object
      Get
    ...
    Friend NotInheritable Class CollectionDebugView
      ...
      Private ReadOnly m_InstanceBeingWatched As Collection
    ...
    Private NotInheritable Class FastList
      ...
      Private Function GetNodeAtIndex(Index As Integer, Optional ByRef PrevNode As Node = Nothing) As Node
        Dim currentNode As Node = m_StartOfList
        Dim currentIndex As Integer = 0
        PrevNode = Nothing
    ...
    Private Structure KeyValuePair
      Private ReadOnly m_Key As Object
    ...
    Private Sub AdjustEnumeratorsHelper(NewOrRemovedNode As Node, Type As ForEachEnum.AdjustIndexType)
...
#Region "Interface Implementation"
    ...
    Private Sub ICollectionCopyTo([array] As System.Array, index As Integer) Implements ICollection.CopyTo
      ...
      If objArray IsNot Nothing Then
        For i = 1 To Count
          objArray(index + i - 1) = Item(i)
        Next i
      Else
        For i = 1 To Count
          [array].SetValue(Item(i), index + i - 1)
        Next i
      End If
    End Sub
