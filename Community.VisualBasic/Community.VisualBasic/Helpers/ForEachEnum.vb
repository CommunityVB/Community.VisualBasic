...
Namespace Global.Community.VisualBasic
  ...
  Friend NotInheritable Class ForEachEnum
    ...
    Private ReadOnly mCollectionObject As Community.VisualBasic.Collection
    ...
    Public Sub New(coll As Community.VisualBasic.Collection)
      MyBase.New()
    ...
    Public Sub Adjust(Node As Collection.Node, Type As AdjustIndexType)
