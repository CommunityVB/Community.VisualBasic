...
Namespace Global.Community.VisualBasic.ApplicationServices
  ...
  Public Class User
    ...
    Public Sub New()
      ...
      'For Windows applications, only projects built on the Windows Application template initialize the 
      'My.User object by default. In all other Windows project types, you must initialize the My.User 
      'object by calling the InitializeWithWindowsUser method explicitly Or by assigning a value To CurrentPrincipal.
