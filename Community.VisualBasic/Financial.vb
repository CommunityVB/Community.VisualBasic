...
Namespace Global.Community.VisualBasic
  ...
  Public Module Financial
    ...
    '-------------------------------------------------------------
    '
    Public Function FV(Rate As Double, NPer As Double, Pmt As Double, Optional PV As Double = 0, Optional Due As DueDate = DueDate.EndOfPeriod) As Double
      Return FV_Internal(Rate, NPer, Pmt, PV, Due)
    End Function

    Private Function FV_Internal(Rate As Double, NPer As Double, Pmt As Double, Optional PV As Double = 0, Optional Due As DueDate = DueDate.EndOfPeriod) As Double
      Dim dTemp As Double
    ...
    '-------------------------------------------------------------
    '
    Public Function IPmt(Rate As Double, Per As Double, NPer As Double, PV As Double, Optional FV As Double = 0, Optional Due As DueDate = DueDate.EndOfPeriod) As Double
    ...
    '-------------------------------------------------------------
    '
    Public Function NPer(Rate As Double, Pmt As Double, PV As Double, Optional FV As Double = 0, Optional Due As DueDate = DueDate.EndOfPeriod) As Double
    ...
    '-------------------------------------------------------------
    '
    Public Function Pmt(Rate As Double, NPer As Double, PV As Double, Optional FV As Double = 0, Optional Due As DueDate = DueDate.EndOfPeriod) As Double
      Return PMT_Internal(Rate, NPer, PV, FV, Due)
    End Function

    Private Function PMT_Internal(Rate As Double, NPer As Double, PV As Double, Optional FV As Double = 0, Optional Due As DueDate = DueDate.EndOfPeriod) As Double
      Dim dTemp As Double
      Dim dTemp2 As Double
      Dim dTemp3 As Double
    ...
    '-------------------------------------------------------------
    '
    Public Function PPmt(Rate As Double, Per As Double, NPer As Double, PV As Double, Optional FV As Double = 0, Optional Due As DueDate = DueDate.EndOfPeriod) As Double
    ...
    '-------------------------------------------------------------
    '
    Public Function PV(Rate As Double, NPer As Double, Pmt As Double, Optional FV As Double = 0, Optional Due As DueDate = DueDate.EndOfPeriod) As Double
    ...
    '-------------------------------------------------------------
    '
    Public Function Rate(NPer As Double, Pmt As Double, PV As Double, Optional FV As Double = 0, Optional Due As DueDate = DueDate.EndOfPeriod, Optional Guess As Double = 0.1) As Double
    ...
    '-------------------------------------------------------------
    '
    Private Function LEvalRate(Rate As Double, NPer As Double, Pmt As Double, PV As Double, dFv As Double, Due As DueDate) As Double
    ...
    Private Function LDoNPV(Rate As Double, ByRef ValueArray() As Double, iWNType As Integer) As Double
    ...
    Private Function OptPV2(ByRef ValueArray() As Double, Optional Guess As Double = 0.1) As Double
