...
Namespace Global.Community.VisualBasic.FileIO
  ...
  Public Class SpecialDirectories
    ...
    Public Shared ReadOnly Property MyDocuments() As String
      Get
        Return GetDirectoryPath(Environment.GetFolderPath(SpecialFolder.Personal), "My Documents")
      End Get
    End Property
    ...
    Public Shared ReadOnly Property MyMusic() As String
      Get
        Return GetDirectoryPath(Environment.GetFolderPath(SpecialFolder.MyMusic), "My Music")
      End Get
    End Property
    ...
    Public Shared ReadOnly Property MyPictures() As String
      Get
        Return GetDirectoryPath(Environment.GetFolderPath(SpecialFolder.MyPictures), "My Pictures")
      End Get
    End Property
    ...
    Public Shared ReadOnly Property Desktop() As String
      Get
        Return GetDirectoryPath(Environment.GetFolderPath(SpecialFolder.Desktop), "Desktop")
      End Get
    End Property
    ...
    Public Shared ReadOnly Property Programs() As String
      Get
        Return GetDirectoryPath(Environment.GetFolderPath(SpecialFolder.Programs), "Programs")
      End Get
    End Property
    ...
    Public Shared ReadOnly Property ProgramFiles() As String
      Get
        Return GetDirectoryPath(Environment.GetFolderPath(SpecialFolder.ProgramFiles), "Program Files")
      End Get
    End Property
    ...
    Public Shared ReadOnly Property Temp() As String
      Get
        Return GetDirectoryPath(IO.Path.GetTempPath(), "Temporary directory")
      End Get
    End Property
    ...
    Public Shared ReadOnly Property CurrentUserApplicationData() As String
      Get
        Return GetDirectoryPath(GetWindowsFormsDirectory("System.Windows.Forms.Application", "UserAppDataPath"), "Current user's application data")
      End Get
    End Property
    ...
    Public Shared ReadOnly Property AllUsersApplicationData() As String
      Get
        Return GetDirectoryPath(GetWindowsFormsDirectory("System.Windows.Forms.Application", "CommonAppDataPath"), "All users' application data")
      End Get
    End Property
    ...
    Private Shared Function GetWindowsFormsDirectory(typeName As String, propertyName As String) As String
      ...
      Return DirectCast([property].GetValue(Nothing, CType(&H2000000, BindingFlags), Nothing, Nothing, Nothing), String)
    End Function
