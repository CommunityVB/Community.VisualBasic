...
Namespace Global.Community.VisualBasic.CompilerServices
  ...
  Friend NotInheritable Class NativeMethods
    ...
    'NOTE: The following appears to be "somewhere else" outside of the VisualBasic runtime...
    ...
    Friend Shared Function GetVolumeInformation(
         <MarshalAs(UnmanagedType.LPTStr)> lpRootPathName As String,
...
nFileSystemNameSize As Integer) As Integer
    ...
    Friend Shared Sub SHChangeNotify(wEventId As UInt32, uFlags As UInt32,
...
dwFlags As Integer) As <MarshalAs(UnmanagedType.Bool)> Boolean
    End Function
