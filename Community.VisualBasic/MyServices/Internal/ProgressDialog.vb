...
Namespace Global.Community.VisualBasic.MyServices.Internal
...
#Else
    ...
    Friend Sub BeginInvoke(doIncrement As Object)
      Throw New PlatformNotSupportedException
    End Sub

    Friend Sub BeginInvoke(doIncrement As Object, increment As Integer)
      Throw New PlatformNotSupportedException
    End Sub
