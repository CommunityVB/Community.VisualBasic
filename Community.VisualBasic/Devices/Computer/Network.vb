  ...
  Public Class Network
    ...
    Sub DownloadFile(address As Uri,
      ...
      Using client As New WebClientExtended
        ...
        If showUI AndAlso System.Environment.UserInteractive Then
          dialog = New ProgressDialog With {.Text = GetResourceString(SR.ProgressDialogDownloadingTitle, address.AbsolutePath),
    ...
    Public Sub UploadFile(sourceFileName As String,
      ...
      Using client As New WebClientExtended()
        ...
        Dim Dialog As ProgressDialog = Nothing
        If showUI AndAlso System.Environment.UserInteractive Then
          Dialog = New ProgressDialog With {.Text = GetResourceString(SR.ProgressDialogUploadingTitle, sourceFileName),
